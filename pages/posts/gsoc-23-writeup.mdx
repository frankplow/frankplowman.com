export const meta = {
  title: 'GSoC 2023: FFmpeg VVC Decoder Improvements',
...
import interPredictionFaultExample from '../../public/ffvvc-inter-prediction-fault-example.png'

<Post id='gsoc-23-writeup' meta={meta}>
...
<Image src={interPredictionFaultExample} alt="Example of VVC decoding failure showing coloured streaks" sizes="100vw" style={{ width: '100%', height: 'auto' }} />
